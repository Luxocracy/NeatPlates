...
local function BuildHubPanel(panel)
	...
	panel.StyleEnemyBarsOnPlayersExcludeFlagged, F = CreateQuickCheckbutton(objectName.."StyleEnemyBarsOnPlayersExcludeFlagged", L["Exclude PvP-Flagged"], AlignmentColumn, F, 32*(1/.8), 0)
	panel.StyleEnemyBarsOnPlayersExcludeFlagged:SetScale(.8)
	panel.StyleEnemyBarsOnPlayersExcludeNonFlagged, F = CreateQuickCheckbutton(objectName.."StyleEnemyBarsOnPlayersExcludeNonFlagged", L["Exclude Non PvP-Flagged"], AlignmentColumn, F, 32*(1/.8), 0)
	panel.StyleEnemyBarsOnPlayersExcludeNonFlagged:SetScale(.8)
	...
	panel.StyleFriendlyBarsOnPlayersExcludeFlagged, F = CreateQuickCheckbutton(objectName.."StyleFriendlyBarsOnPlayersExcludeFlagged", L["Exclude PvP-Flagged"], AlignmentColumn, F, (OffsetColumnB+32)*(1/.8), 0)
	panel.StyleFriendlyBarsOnPlayersExcludeFlagged:SetScale(.8)
	panel.StyleFriendlyBarsOnPlayersExcludeNonFlagged, F = CreateQuickCheckbutton(objectName.."StyleFriendlyBarsOnPlayersExcludeNonFlagged", L["Exclude Non PvP-Flagged"], AlignmentColumn, F, (OffsetColumnB+32)*(1/.8), 0)
	panel.StyleFriendlyBarsOnPlayersExcludeNonFlagged:SetScale(.8)

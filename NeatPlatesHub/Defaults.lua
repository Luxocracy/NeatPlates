...
NeatPlatesHubDefaults = {
	...
	StyleFriendlyBarsOnPlayersExcludeFlagged = false,
	StyleFriendlyBarsOnPlayersExcludeNonFlagged = false,
	...
	StyleEnemyBarsOnPlayersExcludeFlagged = false,
	StyleEnemyBarsOnPlayersExcludeNonFlagged = false,
